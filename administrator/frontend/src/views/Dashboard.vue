<template>
  <div class="dashboard-container">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card card-small animate-fade-in" style="animation-delay: 0.1s">
        <div class="stat-icon-area">
      ...
      <div class="stat-card card-medium animate-fade-in" style="animation-delay: 0.2s">
        <div class="stat-icon-area">
      ...
      <div class="logs-list">
        <div v-for="log in recentLogs" :key="log.logId" class="log-item">
          <div class="log-icon-area">
            <Icon :icon="getLogIcon(log.operation)" :class="getLogClass(log.operation)" />
          </div>
          <div class="log-content">
            <span class="log-description">{{ log.operationDetail }}</span>
            <div class="log-meta">
...
const loadData = async () => {
  try {
    ...
    // 获取最近日志
    const logsRes = await getLogPage({ pageNum: 1, pageSize: 5 })
