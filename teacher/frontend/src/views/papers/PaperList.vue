  ...
  <div class="page-container">
    ...
    <el-dialog v-model="addQuestionDialogVisible" title="选择题目" width="900px">
      <div class="toolbar mb-4">
        ...
        />
        <el-select v-model="questionSearchForm.questionType" placeholder="题型" clearable style="width: 120px">
...
import { getPaperPage, addPaper, updatePaper, deletePaper, getPaperQuestions, addQuestionToPaper } from '@/api/examPaper'
